  ...
  <div class="box">
    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		<div>
				<input type="hidden" name="pavlandingpage[layout_id]" value="99999">
			<table class="form">
						...
						<tr>
						  ...
						  <td><input type="text" name="pavlandingpage[<?php echo $module_row; ?>][text_interval]" value="<?php echo $module['text_interval']; ?>" size="3" /></td>
						</tr>
						

				 		
						<tr>
						  <td><?php echo $this->language->get('text_video_id'); ?></td>
						  <td><input type="text" id="banner_videoid" name="pavlandingpage[<?php echo $module_row; ?>][videoid]" value="<?php echo $module['videoid']; ?>" size="50" />
						  	<p><i><?php echo $this->language->get('text_plain_video_id');?></i></p>
						  </td>
						</tr>
						 ...
						 <tr>
							<td><?php echo $this->language->get('text_image'); ?></td>
							 <td class="left">
							 	<div class="image">
							 		<div class="image-preview">
							 			<img src="<?php echo $modthumb; ?>" alt="" id="modthumb<?php echo $module_row; ?>" />
							 		</div>	

				                  <input type="hidden" name="pavlandingpage[<?php echo $module_row; ?>][mainimage]" value="<?php echo $module['mainimage']; ?>" id="mainimage<?php echo $module_row; ?>"  />
				                  <br />
				                  <a onclick="image_upload('mainimage<?php echo $module_row; ?>', 'modthumb<?php echo $module_row; ?>');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#modthumb<?php echo $module_row; ?>').attr('src', '<?php echo $no_image; ?>'); $('#mainimage<?php echo $module_row; ?>').attr('value', '');"><?php echo $text_clear; ?></a></div>
				              </td>
						</tr>
	...
	// 	  echo '<pre>'.print_r( $banner_image,1 ); die; 
        ...
        <div id="tab-module-<?php echo $banner_row; ?>" class="vtabs-content">
          ...
          <div id="tab-language-<?php echo $banner_row; ?>-<?php echo $language['language_id']; ?>">
         	...
         	<?php 
         	if(isset($banner['title'][$language['language_id']]) && is_array($banner['title'][$language['language_id']] ) ){
...
<script type="text/javascript">
	 $("#content").delegate( ".insert-typo",'click',function(){   
		...
		$('#dialog').remove();
		$('#content').prepend('<div id="dialog" style="padding: 3px 0px 0px 0px;"><iframe src="index.php?route=module/pavlandingpage/typo&token=<?php echo $token;?>&field=' + encodeURIComponent(field) + '" style="padding:0; margin: 0; display: block; width: 100%; height: 100%;" frameborder="no" scrolling="auto"></iframe></div>');
