			...
			<div id="content">
				...
				<table class="compare-info table table-bordered">
					...
					<tr>
						<td></td>
						<?php foreach ($products as $product) { ?>
						<td><input type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button btn btn-outline-black" /></td>
						<?php } ?>
					</tr>
					<tr>
						<td></td>
						<?php foreach ($products as $product) { ?>
						<td class="remove"><a href="<?php echo $product['remove']; ?>" class="button btn btn-outline-black"><?php echo $button_remove; ?></a></td>
						<?php } ?>
					</tr>
				</table>
