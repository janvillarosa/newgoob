				...
				<div class="row">
					<div class="col-lg-6 col-sm-6 col-xs-12">
						...
						<div class="content">
							...
							<p><a href="<?php echo $register; ?>" class="button btn btn-outline-black"><?php echo $button_continue; ?></a></p>						
						</div>
					</div>
					<div class="col-lg-6 col-sm-6 col-xs-12">
						<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" role="form">
							...
							<div class="content underline">
								...
								<input type="submit" value="<?php echo $button_login; ?>" class="button btn btn-outline-black" />
								<?php if ($redirect) { ?>
