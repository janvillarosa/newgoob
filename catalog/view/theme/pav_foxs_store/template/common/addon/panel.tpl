		...
		<div class="panelinner">
			...
			<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="clearfix"><div class="clearfix">
				...
				<p class="group-input pull-right">
					<button value="Apply" class="btn btn-outline-small" name="btn-save" type="submit">Apply</button>
					<a class="btn btn-outline-small" href="<?php echo HTTP_SERVER; ?>?pavreset=?"><span>Reset</span></a>
				</p>
			</div></form>
		</div>	
	</div>
