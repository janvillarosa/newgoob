...
<section class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-12 col-xs-12">
	...
	<div id="content">
		...
		<div class="buttons">
			<div class="right">
				<?php if($cancel_link){ ?>
					<a href="<?php echo $cancel_link; ?>" class="button btn btn-outline-black" onclick="return confirmCancel();"><?php echo $button_cancel_profile; ?></a>
				<?php } ?>
				<a href="<?php echo $continue; ?>" class="button btn btn-outline-black"><?php echo $button_continue; ?></a>
			</div>
		</div>
