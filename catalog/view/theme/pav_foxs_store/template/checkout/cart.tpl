...
<section class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-12 col-xs-12">
	...
	<div id="content">
		...
		<div class="checkout wrapper white no-margin">		
			...
			<div class="cart-module">
				<div id="coupon" class="content" style="display: <?php echo ($next == 'coupon' ? 'block' : 'none'); ?>;">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" role="form">
						...
						&nbsp;
						<input type="submit" value="<?php echo $button_coupon; ?>" class="button btn btn-outline-black" />
					</form>
				</div>
				...
				<div id="voucher" class="content" style="display: <?php echo ($next == 'voucher' ? 'block' : 'none'); ?>;">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" role="form">
						...
						&nbsp;
						<input type="submit" value="<?php echo $button_voucher; ?>" class="button btn btn-outline-black" />
					</form>
				</div>
				...
				<div id="reward" class="content" style="display: <?php echo ($next == 'reward' ? 'block' : 'none'); ?>;">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" role="form">
						...
						&nbsp;
						<input type="submit" value="<?php echo $button_reward; ?>" class="button btn btn-outline-black" />
					</form>
				</div>
				...
				<div id="shipping" class="content" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
					...
					<input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="button btn btn-outline-black" />
				</div>
			</div>
		<?php } ?>
  ...
  <div class="row wrap-checkout">
	<div  class="col-lg-9 col-md-9">  
		<div class="buttons clearfix">
			<div class="pull-right right"><a href="<?php echo $checkout; ?>" class="button btn btn-outline-black"><?php echo $button_checkout; ?></a></div>
			<div class="center pull-left"><a href="<?php echo $continue; ?>" class="button btn btn-outline-black "><?php echo $button_shopping; ?></a></div>
		</div>
	</div>  
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				...
				html += '  <input type="submit" value="<?php echo $button_shipping; ?>" id="button-shipping" class="button btn btn-outline-black" />';	
				<?php } else { ?>
				html += '  <input type="submit" value="<?php echo $button_shipping; ?>" id="button-shipping" class="button btn btn-outline-black" disabled="disabled" />';	
				<?php } ?>
