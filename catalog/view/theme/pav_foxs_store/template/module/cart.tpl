<div id="cart" class="quick-cart clearfix hidden-xs">
	...
	<div class="content">
		...
		<div class="checkout">
			<a href="<?php echo $cart; ?>" class="button btn btn-outline-black"><?php echo $text_cart; ?></a> 
			<a href="<?php echo $checkout; ?>" class="button btn btn-outline-black"><?php echo $text_checkout; ?></a>
		</div>
		<?php } else { ?>
