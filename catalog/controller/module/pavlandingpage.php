...
class ControllermodulePavlandingpage extends Controller {
	protected function index( $setting ) {
		...
		if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/pavlandingpage.css')) {
			$this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/pavlandingpage.css');
		} else {
			$this->document->addStyle('catalog/view/theme/default/stylesheet/pavlandingpage.css');
		}
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/pavlandingpage.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/pavlandingpage.tpl';
		} else {
			$this->template = 'default/template/module/pavlandingpage.tpl';
		}
